...
use MercadoPago\Client\Payment\PaymentClient; // 👈 Adicionar o Cliente
...
MercadoPagoConfig::setAccessToken($token); // 👈 Use setAccessToken
...
try {
    // 1. Instancia o cliente de pagamento (que já usa o token configurado)
